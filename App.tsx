...
const PROJECTS_DATA = [
  { 
    id: '1', 
    title_es: 'Key Visuals Astrix',
    title_en: 'Astrix Key Visuals',
    client: 'ASTRIX', 
  ...
  { 
    id: '2', 
    title_es: 'Contenido RRSS Astrix',
    title_en: 'Astrix Social Media Content',
    client: 'ASTRIX', 
  ...
  { 
    id: '3', 
    title_es: 'Key Visuals Ketal',
    title_en: 'Ketal Key Visuals',
    client: 'KETAL', 
    category_es: 'Campañas',
    category_en: 'Campaigns',
    year: '2017 - 2019',
  ...
  { 
    id: '4', 
    title_es: 'Campaña "Guerreros Solidarios"',
    title_en: '"Solidarity Warriors" Campaign',
    client: 'La Boliviana Ciacruz LBC', 
    category_es: 'Campaña',
    category_en: 'Campaign',
    year: '2020',
    images: ['/assets/work-img/guerreros-solidarios-1.jpg', '/assets/work-img/guerreros-solidarios-2.jpg', '/assets/work-img/guerreros-solidarios-3.jpg', '/assets/work-img/guerreros-solidarios-4.jpg', '/assets/work-img/guerreros-solidarios-5.jpg', '/assets/work-img/guerreros-solidarios-6.jpg'],
    description_es: 'Diseño de la campaña "Guerreros Solidarios" de LBC, destacando historias de coraje, nobleza y fortaleza durante la pandemia del COVID-19.',
    description_en: 'Design for LBC’s "Solidarity Warriors" campaign, highlighting stories of courage, nobility, and strength during the COVID-19 pandemic.'
  },
  { 
    id: '5', 
    title_es: 'Contenido RRSS LBC',
    title_en: 'LBC Social Media Content',
    client: 'La Boliviana Ciacruz LBC', 
    category_es: 'Redes Sociales',
    category_en: 'Social Media',
    year: '2019 - 2022',
    images: ['/assets/work-img/lbc-rrss-1.jpg', '/assets/work-img/lbc-rrss-2.jpg', '/assets/work-img/lbc-rrss-3.jpg', '/assets/work-img/lbc-rrss-4.jpg', '/assets/work-img/lbc-rrss-5.jpg', '/assets/work-img/lbc-rrss-6.jpg', '/assets/work-img/lbc-rrss-7.jpg', '/assets/work-img/lbc-rrss-8.jpg', '/assets/work-img/lbc-rrss-9.jpg', '/assets/work-img/lbc-rrss-10.jpg', '/assets/work-img/lbc-rrss-11.jpg'],
    description_es: 'Diseño de piezas sueltas y campañas de redes sociales para productos de LBC Seguros.',
    description_en: 'Design of standalone pieces and social media campaigns for LBC Seguros products.'
  },
  { 
    id: '6', 
  ...
  { 
    id: '7', 
    title_es: 'Contenido RRSS AXS',
    title_en: 'AXS Social Media Content',
    client: 'AXS', 
    category_es: 'Redes Sociales',
    category_en: 'Social Media',
    year: '2022 - 2023',
    images: ['/assets/work-img/axs-rrss-1.jpg',
      '/assets/work-img/axs-rrss-2.jpg',
      '/assets/work-img/axs-rrss-3.jpg',
      '/assets/work-img/axs-rrss-4.jpg',
      '/assets/work-img/axs-rrss-5.jpg',
      '/assets/work-img/axs-rrss-6.jpg',
      '/assets/work-img/axs-rrss-7.jpg',
      '/assets/work-img/axs-rrss-8.jpg',
      '/assets/work-img/axs-rrss-9.jpg',
      '/assets/work-img/axs-rrss-10.jpg',
      '/assets/work-img/axs-rrss-11.jpg',
      '/assets/work-img/axs-rrss-12.jpg',
      '/assets/work-img/axs-rrss-13.jpg',
      '/assets/work-img/axs-rrss-14.jpg',
      '/assets/work-img/axs-rrss-15.jpg',
      '/assets/work-img/axs-rrss-16.jpg',
      '/assets/work-img/axs-rrss-17.jpg',
      '/assets/work-img/axs-rrss-18.jpg',
      '/assets/work-img/axs-rrss-19.jpg',
      '/assets/work-img/axs-rrss-20.jpg',
      '/assets/work-img/axs-rrss-21.jpg',
      '/assets/work-img/axs-rrss-22.jpg',
      '/assets/work-img/axs-rrss-23.jpg'],
    description_es: 'Diseño de piezas para redes sociales sobre campañas y ofertas de los servicios de Internet y TV Digital de AXS.',
    description_en: 'Design of social media assets for campaigns and promotions of AXS’s Internet and Digital TV services.'
  },
  { 
    id: '8', 
    ...
    category_en: 'Merch',
    year: '2022 - 2023',
    images: ['/assets/work-img/axs-souv-1.jpg',
            '/assets/work-img/axs-souv-2.jpg',
            '/assets/work-img/axs-souv-3.jpg',
            '/assets/work-img/axs-souv-4.jpg',
            '/assets/work-img/axs-souv-5.jpg',
            '/assets/work-img/axs-souv-6.jpg',
            '/assets/work-img/axs-souv-7.jpg',
            '/assets/work-img/axs-souv-8.jpg',
            '/assets/work-img/axs-souv-9.jpg'],
    description_es: 'Diseño de merchandising incluyendo camisetas y packaging para eventos corporativos y patrocinios.',
    description_en: 'Merchandise design including T-shirts and packaging for corporate events and sponsorships.'
  },
  { 
    id: '9', 
    ...
    year: '2022 - 2023',
    images: ['/assets/work-img/axs-stand-1.jpg',
            '/assets/work-img/axs-stand-2.jpg',
            '/assets/work-img/axs-stand-3.jpg',
            '/assets/work-img/axs-stand-4.jpg',
            '/assets/work-img/axs-stand-5.jpg',
            '/assets/work-img/axs-stand-6.jpg'],
    description_es: 'Diseño y visualización 3D para centros de experiencia y stands comerciales de AXS.',
    description_en: 'Design and 3D visualization for AXS experience centers and commercial stands.'
  },
  { 
    id: '10', 
    ...
    year: '2023',
    images: ['/assets/work-img/axs-wpp-1.jpg',
            '/assets/work-img/axs-wpp-2.jpg',
            '/assets/work-img/axs-wpp-3.jpg',
            '/assets/work-img/axs-wpp-4.jpg'],
  ...
  { 
    ...
    category_en: 'Social Media',
    year: '2024',
    images: ['/assets/work-img/dent-rrss-1.jpg',
            '/assets/work-img/dent-rrss-2.jpg',
            '/assets/work-img/dent-rrss-3.jpg',
            '/assets/work-img/dent-rrss-4.jpg',
            '/assets/work-img/dent-rrss-5.jpg',
            '/assets/work-img/dent-rrss-6.jpg',
            '/assets/work-img/dent-rrss-7.jpg',
            '/assets/work-img/dent-rrss-8.jpg'],
  ...
  { 
    ...
    category_en: '3D / Event',
    year: '2025',
    images: ['/assets/work-img/bago1.jpg',
            '/assets/work-img/bago2.jpg',
            '/assets/work-img/bago3.jpg',
            '/assets/work-img/bago4.jpg',
            '/assets/work-img/bago5.jpg'],
  ...
  { 
    ...
    category_en: '3D / Event',
    year: '2025',
    images: ['/assets/work-img/bdp-stand-1.jpg',
            '/assets/work-img/bdp-stand-2.jpg',
            '/assets/work-img/bdp-stand-3.jpg',
            '/assets/work-img/bdp-stand-4.jpg',
            '/assets/work-img/bdp-stand-5.jpg'],
  ...
  { 
    ...
    category_en: '3D / Event',
    year: '2025',
    images: ['/assets/work-img/bdp-conf-1.jpg',
            '/assets/work-img/bdp-conf-2.jpg',
            '/assets/work-img/bdp-conf-3.jpg',
            '/assets/work-img/bdp-conf-4.jpg'],
            ...
            >
              ...
              <div className="w-full md:w-1/3 p-8 md:p-12 flex flex-col bg-[#282828] relative">
                ...
                >
                  ...
                  <h3 className="text-1xl sm:text-2xl md:text-3xl font-heading font-bold uppercase leading-tight text-balance break-normal mb-6 text-white">
